...
function barenblatt(t, args...; m=2, d=1)::Float64
	...
	# this may be improved in performance using max function?
	if big_term <= 0 
		return 0
	else
...
# ╔═╡ 57a30327-77c5-44fe-a7ef-f840df5d14f4
md"""
## 2. Grid Creation and Specifying Constants
"""

# ╔═╡ d958daf0-591b-465f-9c16-bfe6ce83a03e
...
# ╔═╡ 7c703e77-77c3-4b6f-9b31-e3217d02337d
begin
	L = 10
	t0 = 0.001
	m = 3
...
begin
	T1 = range(0, 100; length=50)
	X1 = range(-10, 10; length=50)
	tgrid = repeat(T1',n,1)
	xgrid = repeat(X1,1,n)
...
function porous(;m=2,n=100, dim=1, t0=0.001, h=1.0e-4, t_end=100, L=10)
...
grid_porous,tsol_porous=porous(m=m, dim=dim,n=n);

# ╔═╡ ac74917c-75ff-463c-bd79-61969aa9e049
length(tsol_porous)

# ╔═╡ 99a2568a-38bc-4e1b-a582-805e741d66f1
tsol_porous
